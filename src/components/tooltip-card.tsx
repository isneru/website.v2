...
/*
 * Tooltip Card Component from Aceternity UI
			...
			<AnimatePresence>
				{isVisible && (
					<motion.div
						...
						className='font-mono pointer-events-none absolute z-50 min-w-60 overflow-hidden border border-transparent bg-white ring-1 ring-black/10 dark:bg-black dark:ring-white/10'
						style={{
							top: position.y,
							left: position.x
						}}>
						<div
							ref={contentRef}
							className='p-2 text-sm text-neutral-400 md:p-4 dark:text-neutral-200'>
							{content}
						</div>
					</motion.div>
				)}
